"""
Django settings for late_mouse_42072 project.
...
ROOT_URLCONF = 'late_mouse_42072.urls'
...
WSGI_APPLICATION = 'late_mouse_42072.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_mouse_42072 API",
    "DESCRIPTION": "API documentation for late_mouse_42072 App",
    "VERSION": "v1",
}
